    ...
    for step in range(0, cfg.train_steps+cfg.episode_length, cfg.episode_length):
        ...
        while not episode.done:
            ...
            if ((episode._idx + 2 - context_size) % stride == 0 or episode._idx == cfg.episode_length - 1) and episode._idx >= (context_size-2):
                reward += guidance.get_videotadpole_reward(c_in, latent_history, timestep, alignment_scale=align_scale, recon_scale=recon_scale, noise=source_noise)
